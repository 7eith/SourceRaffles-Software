...
def NotifyCreatedAccount(module, task):
    ...
    try:
        if (webhookURL):
            ...
            embed.set_author(
                name="Successfully created account!" if task.success else "Failed to create account!",
...
def NotifyVerifiedAccount(module, task):
    ...
    try:
        if (webhookURL):
            ...
            embed.set_author(
                name="Successfully verified account!" if task.success else "Failed to verify account!",
                url="https://sourceraffles.com",
                icon_url="https://github.com/SyneziaSoft/Public/blob/main/images/success.gif?raw=true",
            )
...
def NotifyEndAccountVerifier(module, tasksNumber, failedTasks, successTasks, profileName, logsFile):
    ...
    try:
        if (webhookURL):
            ...
            embed.set_author(
                name="Account verifier has ended!",
                url="https://sourceraffles.com",
                icon_url="https://github.com/SyneziaSoft/Public/blob/main/images/success.gif?raw=true",
            )
...
def NotifyEndAccountCreator(module, tasksNumber, failedTasks, successTasks, profileName, logsFile):
    ...
    try:
        if (webhookURL):
            ...
            embed.set_author(
                name="Account creating is completed!",
                url="https://sourceraffles.com",
                icon_url="https://github.com/SyneziaSoft/Public/blob/main/images/success.gif?raw=true",
            )
