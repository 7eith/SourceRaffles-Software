...
def NotifyScrapedEmail(module, task):
    ...
    try:
        if (webhookURL):
            ...
            embed.set_author(
                name="Successfully scraped email !" if task.success else "Failed to scrape email !",
                url="https://sourceraffles.com",
                icon_url="https://github.com/SyneziaSoft/Public/blob/main/images/success.gif?raw=true",
            )

            embed.add_embed_field(name="Site", value="{}".format(module['name']), inline=False)
...
def NotifyEndEmailScraper(module, tasksNumber, failedTasks, successTasks, profileName, logsFile):
    ...
    try:
        if (webhookURL):
            ...
            embed.set_author(
                name="Email scraping is finished !",
                url="https://sourceraffles.com",
                icon_url="https://github.com/SyneziaSoft/Public/blob/main/images/success.gif?raw=true",
            )
