...
class EnterRaffleTask:
    ...
    def __init__(self, index, taskNumber, profile, raffle) -> None:
        ...
        """ Patching email case format """
        Logger.info("{} Patching email case format".format(self.logIdentifier))
        Logger.info("If you have a problem logging in and did not have it before please open a ticket")
        self.profile["email"] = self.profile["email"].lower()
