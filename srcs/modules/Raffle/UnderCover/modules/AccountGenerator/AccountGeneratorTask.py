...
class AccountGeneratorTask:
    ...
    def initializeSession(self):
        ...
        try:
            response = self.session.get("https://store.undercoverism.com/signup")
    ...
    def createAccount(self):
        ...
        try:
            ...
            response = self.session.post('https://store.undercoverism.com/signup/step03', data=data)
    ...
    def confirmCreateAccount(self):
        ...
        data = {
            ...
            'mail': self.profile['email'],
            'password': self.profile['password'],
            'birth': f"{self.birthYear}-{self.birthMonth}-{self.birthDay}",
            'birth_year': self.birthYear,
            'birth_month': self.birthMonth,
            'birth_day': self.birthDay,
            'mail_info_send': '2',
        ...
        try:
            ...
            response = self.session.post('https://store.undercoverism.com/signup/pre_complete', data=data)
