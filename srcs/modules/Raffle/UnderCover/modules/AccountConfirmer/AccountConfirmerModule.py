"""********************************************************************"""
"""                                                                    """
"""   [AccountConfirmer] AccountConfirmerModule.py                     """
"""                                                                    """
"""   Author: seith <seith@synezia.com>                                """
"""                                                                    """
"""   Created: 04/10/2021 06:58:57                                     """
"""   Updated: 22/10/2021 16:23:51                                     """
"""                                                                    """
"""   Synezia Soft. (c) 2021                                           """
"""                                                                    """
"""********************************************************************"""
...
from .AccountConfirmerTask import AccountConfirmerTask
...
class AccountConfirmerModule:
    ...
    def __init__(self) -> None:
        ...
        self.subModuleName = "AccountConfirmer"
            ...
            if self.threads > 1:
                ...
                for index, profile in enumerate(Profiles):
                    ...
                    if profile["status"] == "PENDING" or profile["status"] == "FAILED":
                        TaskResult = AccountConfirmerTask(
