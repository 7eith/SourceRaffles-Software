...
"""                                                                    """
"""   Created: 29/09/2021 20:08:41                                     """
"""   Updated: 29/09/2021 20:10:30                                     """
"""                                                                    """
"""   Synezia Soft. (c) 2021                                           """
"""                                                                    """
"""********************************************************************"""
...
from modules.Raffle.Solebox.modules.EnterRaffle.EnterRaffleTask import EnterRaffleTask
            ...
            if self.threads > 1:
                with ThreadPoolExecutor(max_workers=self.threads) as executor:
                    ...
                    for task in as_completed(tasks):
                        ...
                        setTitle(
                            f"SourceRaffles - Naked [{ProfileName}] | Success: {str(successTask)} - Failed {str(failedTask)} - Remaining {str(remaining)}"
                        )
            else:
                printSeparator()
                for index, profile in enumerate(Profiles):
