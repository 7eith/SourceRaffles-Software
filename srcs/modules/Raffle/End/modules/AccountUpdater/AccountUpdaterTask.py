...
class AccountUpdaterTask:
    ...
    def updateShippingInformations(self, need_new_headers=False):
        ...
        if self.profile["first_name"] == self.firstname:
            Logger.debug("not changing account name")
        else:
            Logger.debug("changing account name")
            Logger.debug("coucou mattei")
        ...
        data = {
            "customer": {
                ...
                "email": self.email,
                "firstname": self.firstname if self.profile["first_name"] == self.firstname else self.profile["first_name"],
                "lastname":  self.lastname if self.profile["last_name"] == self.lastname else self.profile["last_name"],
