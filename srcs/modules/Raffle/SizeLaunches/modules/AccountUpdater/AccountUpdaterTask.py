            ...
            if response.status_code != 200:
                ...
                try:
                    ...
                    if message == "User does not exist.":
                        Logger.info(f"{self.logIdentifier} Account never logged on the SizeLaunches app, creating session...")
        ...
        if response.status_code == 200:
            try:
                ...
                if errorCode == "Refused":
                    Logger.error(f"{self.logIdentifier} Card refused by SizeLaunches")
                    return -1
            except KeyError:
